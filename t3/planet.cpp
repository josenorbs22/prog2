...
Planet* FindPlanet(size_t idPlaneta, const vector<Planet> &v_planets){
    ...
    rA.push_back(18);
    planet.SetRA(rA);
    planet.SetDistance(6334.07);
    planet.SetSize(235423);
    planet.SetExoplanet(true);
    planet.SetSSName("Teste 3");
    planet.SetPos(5);
    planet.SetMaterials("Principalmente teste com alguns vestigios de sera que funciona");
